...
class Config(object):
    ...
    OWNER    = int(os.environ.get("OWNER", "6753014811"))  # ⚠️ Required
...
☛ For e.g :- <code> @ </code> or <code> https:/t.me/sage_xd </code>
"""
...
Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- @sage_xd
"""
